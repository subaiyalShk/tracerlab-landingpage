...
const PKGS: Pkg[] = [
  {
    ...
    hours: 30,
    hoursNote: "ad management, lead qualification & reporting — done for you",
    money: "37 / mo",
    moneyNote: "qualified consultations your $3K ad spend now actually books",
    driver: "A managed funnel turns ad clicks into booked appointments instead of cold form-fills.",
  },
  {
    tier: "Tier 2",
    name: "+ AI Agents",
    hours: 100,
    hoursNote: "a full-time appointment setter's workload — calling & texting, 24/7",
    money: "$225K / mo",
    moneyNote: "revenue at 75× ROAS — the closes slow human follow-up loses",
    driver: "AI contacts every lead in seconds and books it — no lead ever goes cold.",
    featured: true,
  },
  {
    tier: "Tier 3",
    name: "Full Growth + Operations",
    hours: 150,
    hoursNote: "back-office design, permitting & coordination + canvassing admin",
    money: "+ 2 channels",
    moneyNote: "D2D deals on top of paid, plus faster cash from quicker installs",
    driver: "Canvassing adds a second pipeline; automated design & permitting speed every job to install.",
  },
];
