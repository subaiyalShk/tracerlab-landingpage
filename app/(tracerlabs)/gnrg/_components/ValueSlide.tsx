...
const PKGS: Pkg[] = [
  {
    ...
    name: "Marketing",
    hours: 40,
    hoursNote: "your whole demand-to-booking function, run for you",
    money: "$225K / mo",
    moneyNote: "revenue at 75× ROAS — ads + funnel + AI booking fill your calendar",
    driver: "Managed marketing turns ad spend into booked appointments on a calendar we run.",
  },
  {
    tier: "Tier 2",
    name: "Operations Automation",
    hours: 250,
    hoursNote: "manual finance, permitting, design, install & lead-ops work, automated",
    money: "Cash, sooner",
    moneyNote: "sprint-built automations cut weeks off sold-to-installable — fewer errors, more jobs",
    driver: "~2 new automations a month across your back office — you set the priority.",
    featured: true,
  },
  {
    tier: "Tier 3",
    ...
    hours: 290,
    hoursNote: "marketing + operations + field, all run by one team",
    money: "$225K + field",
    moneyNote: "marketing revenue plus a door-to-door channel on top",
    driver: "Everything in Marketing and Operations, plus Offset Canvassing for your D2D team.",
  },
];
