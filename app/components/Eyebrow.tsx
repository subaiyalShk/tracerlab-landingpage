...
export default function Eyebrow({
  ...
  return (
    <div
      className={`bv-9 animate-rise inline-flex items-center gap-2.5 bg-ink/[0.05] py-1.5 pl-2.5 pr-4 backdrop-blur-sm ${className}`}
      style={style}
    >
      ...
      <span className="text-[0.72rem] font-semibold uppercase tracking-[0.22em] text-ink/70">{children}</span>
    </div>
  );
}
